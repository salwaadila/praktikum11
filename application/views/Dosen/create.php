<div class="content-wrapper">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tempat" name="tempat" placeholder="Tempat Lahir" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="tanggal" class="col-4 col-form-label">Tanggal Lahir</label> 
    <div class="col-8">
      <input id="tanggal" name="tanggal" placeholder="Tanggal Lahir" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="pendidikan" name="pendidikan" placeholder="Pendidikan" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
